...
const styles: Record<string, React.CSSProperties> = {
  ...
  runBtn: { background: '#2563eb', color: '#fff', padding: '0.6rem 1.25rem', borderRadius: '6px', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 500 },
  statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '2rem' },
  statCard: { background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '1.25rem' },
  statValue: { fontSize: '2rem', fontWeight: 700, color: '#111827', lineHeight: 1 },
  statLabel: { fontSize: '0.85rem', color: '#6b7280', margin: '0.35rem 0 0.5rem' },
  ...
  panelTitle: { margin: 0, fontSize: '1rem', fontWeight: 600 },
  ...
  pageTypeBadge: { display: 'inline-block', background: '#f3f4f6', color: '#9ca3af', padding: '0.05rem 0.35rem', borderRadius: '3px', fontSize: '0.65rem', marginRight: '0.35rem' },
  allGood: { textAlign: 'center' as const, padding: '2rem 1rem' },
  quickLinks: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem' },
  quickLink: { display: 'flex', flexDirection: 'column' as const, alignItems: 'center', gap: '0.5rem', padding: '1.25rem', background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '8px', textDecoration: 'none', color: '#374151', fontSize: '0.875rem', fontWeight: 500 },
};
