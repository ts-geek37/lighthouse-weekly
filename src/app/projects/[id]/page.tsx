...
const styles: Record<string, React.CSSProperties> = {
  ...
  urlCard: { background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '1rem' },
  ...
  th: { textAlign: 'left' as const, padding: '0.6rem 0.75rem', borderBottom: '2px solid #e5e7eb', fontWeight: 600, fontSize: '0.75rem', color: '#6b7280', textTransform: 'uppercase' as const },
