...
const styles: Record<string, React.CSSProperties> = {
  ...
  runBtn: { background: '#2563eb', color: '#fff', padding: '0.5rem 1rem', borderRadius: '6px', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 500 },
  toolbar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  filterSelect: { padding: '0.4rem 0.75rem', border: '1px solid #d1d5db', borderRadius: '6px', fontSize: '0.875rem' },
  count: { fontSize: '0.875rem', color: '#6b7280' },
  empty: { textAlign: 'center' as const, padding: '3rem', color: '#6b7280' },
  table: { width: '100%', borderCollapse: 'collapse' as const },
  th: { textAlign: 'left' as const, padding: '0.75rem', borderBottom: '2px solid #e5e7eb', fontWeight: 600, fontSize: '0.8rem', color: '#374151', textTransform: 'uppercase' as const, letterSpacing: '0.05em' },
  ...
  failedBadge: { display: 'inline-block', background: '#fee2e2', color: '#991b1b', padding: '0.15rem 0.4rem', borderRadius: '4px', fontSize: '0.75rem' },
