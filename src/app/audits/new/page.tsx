...
const styles: Record<string, React.CSSProperties> = {
  ...
  runBtn: { padding: '0.65rem 2rem', backgroundColor: '#2563eb', color: '#fff', border: 'none', borderRadius: '6px', fontSize: '1rem', fontWeight: 600, cursor: 'pointer' },
  loadingBox: { display: 'flex', alignItems: 'flex-start', gap: '1rem', backgroundColor: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '8px', padding: '1.25rem', marginBottom: '1.5rem' },
  ...
  errorBox: { backgroundColor: '#fee2e2', border: '1px solid #fca5a5', borderRadius: '8px', padding: '1rem', color: '#991b1b', marginBottom: '1.5rem' },
  resultCard: { backgroundColor: '#fff', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '1.5rem' },
  resultHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' },
  viewBtn: { padding: '0.4rem 0.9rem', backgroundColor: '#f3f4f6', color: '#374151', borderRadius: '6px', textDecoration: 'none', fontSize: '0.875rem', whiteSpace: 'nowrap' as const },
  scoresGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '1.5rem' },
  scoreCard: { textAlign: 'center' as const, padding: '1rem', backgroundColor: '#f9fafb', borderRadius: '8px' },
